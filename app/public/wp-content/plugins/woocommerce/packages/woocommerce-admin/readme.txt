...
Stable tag: 1.1.3
License: GPLv3
License URI: https://github.com/woocommerce/woocommerce-admin/blob/oligarch/license.txt
...
- Fix: Fix checkout of oligarch branch in CI environment. #3296 (Build)
...
- Dev: Only build pushes to oligarch branch. #2941 (Build)
